...
/// </summary>
public static class OperandStreamZipExtensions {
    /// <summary>
    ...
    public static IOperandStream<(TValue, TAdditionalValue)> Zip<TValue, TAdditionalValue>(this IOperandStream<TValue> operandStream, IOperandStream<TAdditionalValue> additionalStream)
        => operandStream.Pipe(new Zip<TValue, TAdditionalValue>(), additionalStream);
}
