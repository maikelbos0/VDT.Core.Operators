...
public static class OperandStreamExtensions {
    ...
    public static IOperandStream<TNewValue> Map<TValue, TNewValue>(this IOperandStream<TValue> operandStream, Func<TValue, TNewValue> func)
        => operandStream.Pipe(new Map<TValue, TNewValue>(func));
